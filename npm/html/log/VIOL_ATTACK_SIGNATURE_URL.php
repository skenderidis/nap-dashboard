...
<table class="table table-bordered table-striped table-violation" style=" font-size:12px">
	...
	<tbody>
		...
		<tr>
			<td>Context</td>
			<td><b>Url</b>
			<button type="button" class="btn btn_float_right btn-sm btn-dark learn_btn modal_open" data-bs-toggle="modal" data-bs-target="#violation_modal" aria-expanded="false" id="attack_sig_url" value="<?php echo $total_count;?>">Disable Signature on URL</button>					
			</td>
		</tr>
		<tr>
			<td>Violation</td>
